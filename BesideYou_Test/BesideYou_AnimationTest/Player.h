...
protected:
	...
	////1
	//CCharacterStatus*			m_pCharacterStatus;
...
public:
	...
	////1
	//void SetPlayerCharacterStatus()
	//{
	//	//초기 세팅
	//	m_pCharacterStatus = new CCharacterStatus();
	//	m_pCharacterStatus->SetInfantryType(INFANTRYTYPE::GUNNER);
	//}
};
